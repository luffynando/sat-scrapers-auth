 ...
 * @see GuzzleException
 */
final class SatHttpGatewayClientException extends SatHttpGatewayException implements SatException
{
    private readonly \GuzzleHttp\Exception\GuzzleException $clientException;
