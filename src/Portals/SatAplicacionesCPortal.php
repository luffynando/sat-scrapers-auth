...
final class SatAplicacionesCPortal extends AbstractSatPortal implements SatPortal
{
    ...
    public const AUTH_LOGIN_POST = 'https://loginc.mat.sat.gob.mx/nidp/saml2/spassertion_consumer';
    ...
    final public const AGR_LOGOUT_POST = 'https://loginc.mat.sat.gob.mx/nidp/saml2/spslo';
    ...
    {
        return is_numeric(strpos($html, 'Mensajes de inter'));
    }
